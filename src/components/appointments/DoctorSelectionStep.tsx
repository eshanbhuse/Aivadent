                  ...
                  >
                    <CardHeader className="pb-4">
                        <div className="flex items-start gap-4">
                            <Image src={dentist.imageUrl!} alt="" width={64} height={64} className="rounded-full object-cover w-16 h-16"/>
                    ...
                    <CardContent className="space-y-3">
                        ...
                        <p className="text-sm text-muted-foreground">
                            {dentist.bio || "Experienced dentist dedicated to providing quality care and creating beautiful smiles."}
                        </p>
