  ...
  return (
    <div className="grid md:grid-cols-2 gap-8 mb-12">
        ...
        <CardHeader className="relative">
            ...
            <CardDescription>
                Simple steps to get started with our AI Voice Assistant.
            </CardDescription>
        ...
        <CardContent className="relative space-y-4">
            ...
            <div className="flex items-center gap-3">
                <div className="w-2 h-2 bg-primary rounded-full mt-2"></div>
                <span className="text-sm">Ask question about dental health and treatment</span>
            </div>
            <div className="flex items-center gap-3">
                <div className="w-2 h-2 bg-primary rounded-full mt-2"></div>
        ...
        <CardContent className="relative space-y-4">
            ...
            <div className="flex items-center p-3 bg-muted/30 rounded-xl">
                ...
                <span className="font-medium text-sm">Conversational History</span>
            </div>
