...
const HowItWorks = () => {
  return (
    <section className='relative py-32 px-6 outline-hidden z-10 max-w-7xl mx-auto'>
      ...
      <p className='text-xl text-muted-foreground max-w-3xl leading-relaxed mx-auto'>Discover how AIVADENT simplifies your dental care journey in just three easy steps. From consultation to treatment, we've got you covered.</p>
      </div>
