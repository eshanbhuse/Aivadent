          ...
          <div className='grid lg:grid-cols-2 gap-16 items-center'>
            <div className='space-y-10'>
              <div className='space-y-6'>
                <div className='inline-flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-primary/10 to-primary/5 rounded-full border border-primary/20 bakcdrop-blur-sm'>
                <div className='w-2 h-2 bg-primary rounded-full animate-pulse'></div>
                <span className='text-sm font-medium text-primary'>AI-Powered Dental Assistance</span>
                </div>
                ...
                <p className='text-lg text-muted-foreground max-w-xl font-medium leading-relaxed'>Experience the future of dental care with AI-driven answers to all your dental health questions. Fast, reliable, and always available.</p>
              </div>
              ...
              <div className='pt-8'>
                <div className='flex items-center gap-6'>
                  <div className='flex -space-x-3'>
                    <Image src="/brain.png" alt="" width={48} height={48} className='w-12 h-12 rounded-full object-cover ring-4 ring-background' />
                    <Image src="/brain.png" alt="" width={48} height={48} className='w-12 h-12 rounded-full object-cover ring-4 ring-background' />
                    <Image src="/brain.png" alt="" width={48} height={48} className='w-12 h-12 rounded-full object-cover ring-4 ring-background' />
                    <Image src="/brain.png" alt="" width={48} height={48} className='w-12 h-12 rounded-full object-cover ring-4 ring-background' />
                  </div>
            ...
            <div className='relative lg:pl-8'>
              ...
              <div className='absolute -bottom-6 -right-6 w-32 h-32 bg-gradient-to-br from-primary/25 to-primary/5 rounded-full blur-2xl'></div>
              <Image src="/hero.png" alt="" width={600} height={600} className='w-full h-auto ' />
            </div>
          </div>
        </div>
      </div>
