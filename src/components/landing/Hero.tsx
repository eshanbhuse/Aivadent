...
const Hero = () => {
  return (
    <section className="relative h-auto lg:h-screen flex items-center overflow-hidden pt-20">
      {/* GRID BG */}
            ...
            <div className="space-y-10">
              <div className="space-y-6">
                ...
                <p className="text-lg text-muted-foreground max-w-xl font-medium leading-relaxed">
                  Experience the future of dental care with AI-driven answers to all your dental health questions. Fast, reliable, and always available.
                </p>
              </div>
                ...
                <div className="flex items-center gap-6">
                  ...
                  <div className="space-y-1">
                    ...
                    <p className="text-sm text-muted-foreground">
                      Trusted by <span className="font-semibold text-foreground">500+ patients</span>
                    </p>
                  </div>
                </div>
              </div>
